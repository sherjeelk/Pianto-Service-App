(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~calendar-calendar-module~completion-completion-module~dashboard-dashboard-module~home-home-m~870e2586"],{
...
/* harmony import */ var _session_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./session.service */ "./src/app/services/session.service.ts");
...
let UtilService = class UtilService {
    constructor(api, toast, snackBar, session, router) {
        this.api = api;
        this.toast = toast;
        ...
        this.router = router;
        this.loading = false;
        this.orderUpdate = new rxjs__WEBPACK_IMPORTED_MODULE_6__["BehaviorSubject"](false);
    }
    getHumanShortDate(date) {
        return moment__WEBPACK_IMPORTED_MODULE_2__(date).format('DD-MMM-YYYY');
    }
    getTime(date) {
        return moment__WEBPACK_IMPORTED_MODULE_2__(date).format('H:mm');
    }
...
//# sourceMappingURL=default~calendar-calendar-module~completion-completion-module~dashboard-dashboard-module~home-home-m~870e2586-es2015.js.map