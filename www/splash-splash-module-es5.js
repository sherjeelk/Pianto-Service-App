  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["splash-splash-module"], {
    ...
    function srcAppSplashSplashPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var SplashPage = /*#__PURE__*/function () {
        function SplashPage(session, router, util, platform, statusBar, storage) {
        ...
        _createClass(SplashPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.storage.getValue('first').then(function (val) {
              if (val) {
                _this.session.auth.subscribe(function (data) {
                  if (data) {
                ...
                console.log('Login', _this.storage.getValue('loggedIn').then(function (login) {
                  return login;
                }));
