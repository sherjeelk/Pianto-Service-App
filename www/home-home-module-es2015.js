...
/* harmony import */ var _order_history_order_history_module__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../order-history/order-history.module */ "./src/app/order-history/order-history.module.ts");
...
HomePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _order_history_order_history_module__WEBPACK_IMPORTED_MODULE_14__["OrderHistoryPageModule"]
        ],
...
/* harmony import */ var _modals_earning_popup_earning_popup_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../modals/earning-popup/earning-popup.page */ "./src/app/modals/earning-popup/earning-popup.page.ts");
...
/* harmony import */ var _modals_details_sheet_details_sheet_page__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../modals/details-sheet/details-sheet.page */ "./src/app/modals/details-sheet/details-sheet.page.ts");
/* harmony import */ var _services_local_storage_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../services/local-storage.service */ "./src/app/services/local-storage.service.ts");
/* harmony import */ var _modals_earning_sheet_earning_sheet_page__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../modals/earning-sheet/earning-sheet.page */ "./src/app/modals/earning-sheet/earning-sheet.page.ts");
...
let HomePage = class HomePage {
    constructor(local, util, api, session, dialog, alertController, bottomSheet) {
        this.local = local;
        this.util = util;
        this.api = api;
    ...
    sendFCMToken() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            if (fcmToken) {
                try {
                    yield this.api.setFCMToken(this.session.getUser().id, fcmToken);
                }
                catch (e) {
    ...
    getNextDays() {
        ...
        const arrDays = [];
        while (daysToGet) {
            const current = moment__WEBPACK_IMPORTED_MODULE_7__(this.date).add(daysToGet, 'day');
    ...
    getOrdersByDate(start, user) {
        ...
        const end = moment__WEBPACK_IMPORTED_MODULE_7__(start).endOf('day').toDate().toISOString();
        this.api.getOrdersByDate(start, end, user).subscribe(data => {
            this.allOrders = data;
            this.allOrders = lodash__WEBPACK_IMPORTED_MODULE_8__["filter"](this.allOrders, (order) => {
    ...
    openDialog(order) {
        ...
        const dialogRef = this.dialog.open(_modals_earning_popup_earning_popup_page__WEBPACK_IMPORTED_MODULE_5__["EarningPopupPage"], {
            width: '350px',
            data: { order }
        });
    ...
    removePreviousSLots() {
        ...
        this.api.getUser(this.session.getUser().id).subscribe(data => {
            ...
            // get unique slots
            this.allSlots = lodash__WEBPACK_IMPORTED_MODULE_8__["difference"](this.allSlots, slots);
            const body = {
                slots: this.allSlots
            };
    ...
    getOrders() {
        this.api.getOrdersByDate(moment__WEBPACK_IMPORTED_MODULE_7__().startOf('day').toDate().toISOString(), moment__WEBPACK_IMPORTED_MODULE_7__().add('365', 'days').toDate().toISOString(), this.session.getUser().id).subscribe(data => {
            // this.weekOrders = data;
            this.orders = lodash__WEBPACK_IMPORTED_MODULE_8__["filter"](data, el => (el.status === 'PAYMENT_CONFIRMED' || el.status === 'COMPLETED'));
            this.orders = lodash__WEBPACK_IMPORTED_MODULE_8__["sortBy"](this.orders, 'date', 'time');
        }, error => {
