(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dashboard-dashboard-module"], {
    ...
    function srcAppDashboardDashboardModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _modals_earning_popup_earning_popup_page__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      ...
      var _modals_review_popup_review_popup_page__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ../modals/review-popup/review-popup.page */
      ...
      DashboardPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _dashboard_routing_module__WEBPACK_IMPORTED_MODULE_5__["DashboardPageRoutingModule"], _angular_material_tabs__WEBPACK_IMPORTED_MODULE_7__["MatTabsModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_8__["MatCardModule"], _angular_material_expansion__WEBPACK_IMPORTED_MODULE_9__["MatExpansionModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_11__["MatDialogModule"], _angular_material_bottom_sheet__WEBPACK_IMPORTED_MODULE_13__["MatBottomSheetModule"]],
    ...
    function srcAppDashboardDashboardPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _modals_earning_popup_earning_popup_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ../modals/earning-popup/earning-popup.page */
      "./src/app/modals/earning-popup/earning-popup.page.ts");
      /* harmony import */
      ...
      var _modals_review_sheet_review_sheet_page__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ../modals/review-sheet/review-sheet.page */
      "./src/app/modals/review-sheet/review-sheet.page.ts");
      /* harmony import */


      var _modals_earning_sheet_earning_sheet_page__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ../modals/earning-sheet/earning-sheet.page */
      "./src/app/modals/earning-sheet/earning-sheet.page.ts");

      var DashboardPage = /*#__PURE__*/function () {
        function DashboardPage(bottomSheet, dialog, api, modalController, session, util) {
          ...
          this.dates = [{
            start: moment__WEBPACK_IMPORTED_MODULE_4__().subtract(7, 'days')
          }, {
            start: moment__WEBPACK_IMPORTED_MODULE_4__().subtract(30, 'days'),
            end: moment__WEBPACK_IMPORTED_MODULE_4__()
          }, {
            start: moment__WEBPACK_IMPORTED_MODULE_4__().subtract(365, 'days'),
            end: moment__WEBPACK_IMPORTED_MODULE_4__()
          }];
        }
        ...
        _createClass(DashboardPage, [{
          ...
          key: "getTotalEarning",
          value: function getTotalEarning(type) {
            if (type === 1) {
          ...
          key: "getWeeklyOrder",
          value: function getWeeklyOrder() {
            var _this = this;

            this.api.getOrdersByDate(moment__WEBPACK_IMPORTED_MODULE_4__().subtract(7, 'days').toDate().toISOString(), moment__WEBPACK_IMPORTED_MODULE_4__().toDate().toISOString(), this.session.getUser().id).subscribe(function (data) {
              // this.weekOrders = data;
              _this.weekOrders = lodash__WEBPACK_IMPORTED_MODULE_5__["filter"](data, {
                status: 'COMPLETED'
              });
              console.log('these are week orders', _this.weekOrders);
            }, function (error) {
          ...
          key: "getMonthlyOrder",
          value: function getMonthlyOrder() {
            var _this2 = this;

            this.api.getOrdersByDate(moment__WEBPACK_IMPORTED_MODULE_4__().subtract(30, 'days').toDate().toISOString(), moment__WEBPACK_IMPORTED_MODULE_4__().toDate().toISOString(), this.session.getUser().id).subscribe(function (data) {
              // this.monthOrders = data;
              _this2.monthOrders = lodash__WEBPACK_IMPORTED_MODULE_5__["filter"](data, {
                status: 'COMPLETED'
              });
            }, function (error) {
          ...
          key: "getAnnualOrder",
          value: function getAnnualOrder() {
            var _this3 = this;

            this.api.getOrdersByDate(moment__WEBPACK_IMPORTED_MODULE_4__().subtract(365, 'days').toDate().toISOString(), moment__WEBPACK_IMPORTED_MODULE_4__().toDate().toISOString(), this.session.getUser().id).subscribe(function (data) {
              // this.yearOrders = data;
              _this3.yearOrders = lodash__WEBPACK_IMPORTED_MODULE_5__["filter"](data, {
                status: 'COMPLETED'
              });
              console.log('**************', _this3.yearOrders);
            }, function (error) {
              console.log('an error occurred while fetching annual Order data', error);
            });
          }
        }, {
          key: "getWeeklyReviews",
          value: function getWeeklyReviews() {
            var _this4 = this;

            this.type = 1;
            this.api.getReviewsByDate(moment__WEBPACK_IMPORTED_MODULE_4__().subtract(7, 'days').toDate().toISOString(), moment__WEBPACK_IMPORTED_MODULE_4__().toDate().toISOString(), this.session.getUser().id).subscribe(function (data) {
              _this4.weekReviews = data;
              console.log('this review data from week review method ^^^^^^^^', _this4.weekReviews);

              _this4.getAvgReview(1);
            }, function (error) {
              console.log('an error occurred while fetching weekly order data', error);
            });
          }
        }, {
          key: "getMonthlyReviews",
          value: function getMonthlyReviews() {
            var _this5 = this;

            this.type = 2;
            this.api.getReviewsByDate(moment__WEBPACK_IMPORTED_MODULE_4__().subtract(30, 'days').toDate().toISOString(), moment__WEBPACK_IMPORTED_MODULE_4__().toDate().toISOString(), this.session.getUser().id).subscribe(function (data) {
              _this5.monthReviews = data;
              console.log('this review data from week review method ^^^^^^^^', _this5.monthReviews);

              _this5.getAvgReview(2);
            }, function (error) {
              console.log('an error occurred while fetching monthly data', error);
            });
          }
        }, {
          key: "getAnnualReviews",
          value: function getAnnualReviews() {
            var _this6 = this;

            this.type = 3;
            this.api.getReviewsByDate(moment__WEBPACK_IMPORTED_MODULE_4__().subtract(365, 'days').toDate().toISOString(), moment__WEBPACK_IMPORTED_MODULE_4__().toDate().toISOString(), this.session.getUser().id).subscribe(function (data) {
              _this6.yearReviews = data;
              console.log('this review data from week review method ^^^^^^^^', _this6.yearReviews);

              _this6.getAvgReview(3);
            }, function (error) {
              console.log('an error occurred while fetching annual Order data', error);
            });
          ...
          key: "openReviewBottomSheet",
          value: function openReviewBottomSheet(review) {
          ...
          key: "presentModal",
          value: function presentModal(order) {
          ...
          key: "getAvgReview",
          value: function getAvgReview(type) {
            if (type === 1) {
